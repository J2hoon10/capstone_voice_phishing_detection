"""
koelectra_mamba_sent_window / train.py

hce_ordinal 대비 전처리 변경 사항:
  - 슬라이딩 윈도우(WINDOW_SIZE=128, STRIDE=100) → 문장 단위 의미 보존 분할
...
EXP_NAME = "koelectra_mamba_sent_window"
...
def train(resume: bool = False) -> None:
    ...
    print(
        f"[train] segmentation=sentence-based  WINDOW_SIZE={WINDOW_SIZE}  BATCH_SIZE={TRAIN_CONFIG['BATCH_SIZE']}"
    )
    print(
