...
class KoBertAvgPoolClassifier(nn.Module):
    """KoBERT + MeanPooling(토큰) + 세그먼트 평균 풀링 + MLP.

    koelectra_phishing5 대비 변경 사항:
      - 인코더: KoELECTRA-base-v3 → KoBERT (monologg/kobert)
...
def build_model() -> KoBertAvgPoolClassifier:
    return KoBertAvgPoolClassifier(
