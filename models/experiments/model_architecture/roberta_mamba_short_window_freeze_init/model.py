"""
roberta_mamba_short_window_freeze_init / model.py

koelectra_mamba_short_window_freeze_init 과 동일한 아키텍처.
  - 인코더: KLUE-RoBERTa-base (klue/roberta-base)
  - NUM_LAYERS=1, WINDOW_SIZE=64, STRIDE=32
  - build_model(): unfreeze_all=True
    encoder freeze 전략은 train.py 에서 직접 관리한다.
    (처음 FREEZE_INIT_EPOCHS 동안 전체 freeze → 이후 layer[10~11] unfreeze)
"""
