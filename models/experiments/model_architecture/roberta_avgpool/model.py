...
class RoBertaAvgPoolClassifier(nn.Module):
    """KLUE-RoBERTa + MeanPooling(토큰) + 세그먼트 평균 풀링 + MLP.

    koelectra_phishing5 대비 변경 사항:
      - 인코더: KoELECTRA-base-v3 → KLUE-RoBERTa-base (klue/roberta-base)
...
def build_model() -> RoBertaAvgPoolClassifier:
    return RoBertaAvgPoolClassifier(
