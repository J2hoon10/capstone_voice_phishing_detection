...
데이터셋: 한국어 SNS 일상대화 (normal_data_reference/Training, normal_data_reference/Validation)
...
DATA_ROOT = PROJECT_ROOT / "normal_data_reference"                                        # 원본 JSON (Training/ Validation/)
