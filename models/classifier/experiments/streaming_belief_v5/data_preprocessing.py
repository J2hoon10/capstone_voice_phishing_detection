...
5) Use Data/Validation/**/*.json as test
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="raw",
        help="raw: build overlap sliding-window cache from Data/Training+Validation, compressive: copy existing turn-level cache",
    )
    parser.add_argument(
        "--overwrite",
        action="store_true",
