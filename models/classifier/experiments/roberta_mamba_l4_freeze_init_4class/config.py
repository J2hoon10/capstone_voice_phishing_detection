...
# 표준 고정 윈도우 (streaming_belief_v5 / koelectra_mamba_freeze_init 동일)
...
TRAIN_CONFIG = {
    ...
    "UPPER_LR": 3e-4,        # L2(5e-4) → L4: 파라미터 증가로 보수적 LR
    "UPPER_MIN_LR": 1e-4,    # Mamba+Head cosine 하한
    ...
    "FREEZE_INIT_EPOCHS": 4,  # L2(3) → L4: 더 깊어져 수렴에 시간 필요
}
