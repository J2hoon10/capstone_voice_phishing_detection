...
# audio_processor는 models/main/model_architecture/ 에 위치
_THIS_DIR = os.path.dirname(os.path.abspath(__file__))
_MODEL_ARCH_DIR = os.path.join(os.path.dirname(_THIS_DIR), "model_architecture")
if _MODEL_ARCH_DIR not in sys.path:
    sys.path.insert(0, _MODEL_ARCH_DIR)
